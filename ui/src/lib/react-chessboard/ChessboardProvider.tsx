...
// DEBUG LOGS FOR CRITICAL DEPENDENCIES
console.log('=== CHESSBOARD PROVIDER DEBUG ===');
console.log('DndContext import:', DndContext);
console.log('TouchSensor:', TouchSensor);
console.log('MouseSensor:', MouseSensor);
...
export const useChessboardContext = () => useContext(ChessboardContext) as ContextType;
...
export function ChessboardProvider({
  ...
  const board = useMemo(() => {
    try {
      const b = generateBoard(chessboardRows, chessboardColumns, boardOrientation);
      console.log('generateBoard result:', b ? 'Assigned' : 'UNDEFINED');
      return b || [];
    } catch (e) {
      console.error('generateBoard critical error:', e);
      return [];
    }
  }, [chessboardRows, chessboardColumns, boardOrientation]);
