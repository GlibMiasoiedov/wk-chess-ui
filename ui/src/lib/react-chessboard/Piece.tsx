...
export const Piece = memo(function Piece({
  ...
  if (!PieceSvg) {
    console.error(`ChessBoard Critical: Unknown piece type "${pieceType}" at ${position}. Available keys:`, Object.keys(pieces));
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: clone ? 'none' : 'auto', // Fix: Allow drop detection by passing events through clone
      }}
      onClick={() =>
